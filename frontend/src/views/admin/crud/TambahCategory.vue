...
import { Tag, X, PlusCircle, ArrowLeft } from 'lucide-vue-next'
      ...
      <div class="px-8 py-6">
        <div class="flex items-center justify-between gap-6">
          <div class="flex-1">
            ...
            <p class="text-blue-100 text-sm mt-1 opacity-90">Tambahkan kategori produk baru ke dalam sistem</p>
          </div>
      ...
      <div class="max-w-4xl mx-auto">
        <div class="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden">
          <div class="px-8 py-6 bg-linear-to-r from-blue-50 to-blue-100 border-b border-blue-200">
            <h2 class="text-xl font-bold text-gray-800">Formulir Kategori</h2>
          </div>
          ...
          <form @submit.prevent="submit" class="p-6 md:p-8 space-y-8">
            ...
            <div class="flex justify-end space-x-4 pt-8 border-t border-gray-100">
              ...
              <button type="submit" :disabled="loading"
                ...
                <PlusCircle class="w-5 h-5 mr-2 group-hover:scale-110 transition-transform" />
                Simpan Kategori
              </button>
            </div>
          </form>
